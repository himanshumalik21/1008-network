      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="p-6 sm:p-8 rounded-2xl bg-surface-100/60 border border-white/[0.08] text-xs sm:text-sm text-muted leading-relaxed space-y-6 font-sans">
          <section className="space-y-2">
            <h2 className="text-base font-bold text-white">1. Nature of Platform</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-base font-bold text-white">2. 1008 Capital Syndicate Notice</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-base font-bold text-white">3. 60-Day Partner Network Standard</h2>
            <p>

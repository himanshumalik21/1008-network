...
export default function ReadinessPage() {
  return (
    <div className="pt-28 pb-20">
      <section className="relative py-12 border-b border-border bg-surface-100/40">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-3">
          <div className="inline-flex items-center gap-2">
            <Badge variant="amber" size="md" pulse>
              Diagnostic Tool // 8 Questions
            </Badge>
            <span className="text-xs font-mono text-muted-foreground">2-Minute Venture Assessment</span>
          </div>

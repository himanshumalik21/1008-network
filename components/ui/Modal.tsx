...
export function Modal({
  ...
  const modalContent = (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
      ...
      <div
        className={cn(
          "relative w-full z-10 my-auto sm:my-8 rounded-2xl bg-white border border-[#E6E8EB] p-5 sm:p-8 text-[#0A2540] shadow-[0_20px_60px_-15px_rgba(10,37,64,0.15)] transition-all duration-300 animate-in zoom-in-95 max-h-[90vh] max-h-[90dvh] overflow-y-auto overflow-touch",
          widthMap[maxWidth]
        )}
      >
        {/* Close Button */}

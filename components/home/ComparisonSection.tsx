  ...
  const comparisonData = [
    {
      ...
      studio1008: "Shared Venture Equity & Milestone Upside. We act as your co-builder—orchestrating talent, software, and suppliers to build real enterprise value.",
      agency: "Hourly consulting fees and monthly retainers, with financial risk borne entirely by the founder.",
      incubator: "Fixed equity for classroom lectures and cohort networking, with limited ground operational execution.",
      solo: "100% personal capital burn; higher execution risk navigating multiple uncoordinated contractors.",
    },
    {
      dimension: "Software, Systems & Supply Chain",
      studio1008: "Direct Operational Build: We architect the production tech stack, configure cloud ERPs, and assist in OEM supplier onboarding.",
      agency: "Limited to scoped project deliverables, branding decks, or mockups without long-term operational integration.",
      incubator: "Mentorship advice without hands-on software development, factory auditing, or infrastructure setup.",
      solo: "Managing disconnected freelancers and vendors alone, risking integration delays and fragmented codebases.",
    },
    {
      dimension: "Key Operator Hiring & Commercial GTM",
      studio1008: "We connect domain founders with curated technical CTOs, operations managers, and GTM sales leaders.",
      agency: "Marketing campaigns without dedicated full-time leadership recruiting or direct enterprise sales pipelines.",
      incubator: "Broad investor demo day with no direct assistance in closing commercial pilots or hiring operators.",
      solo: "Founder is stretched thin between hiring, managing daily fires, and trying to close sales alone.",
    },
    {
      dimension: "Transition to Founder Autonomy",
      studio1008: "Structured phased handover engineered to make the founding team fully self-reliant with zero vendor lock-in.",
      agency: "Incentivized by ongoing retainer relationships rather than building client internal autonomy.",
      incubator: "Fixed-duration cohort program ending with Demo Day, after which operational support concludes.",
      solo: "Indefinite operational firefighting that can lead to founder burnout and stalled growth.",
    },
  ];

  ...
  const comparison = [
    {
      ...
      studio1008: "Shared Equity & Milestone Upside. We act as your venture facilitator—orchestrating talent, tools, and vendors to build real enterprise value.",
    ...
    },
    {
      ...
      studio1008: "Direct Facilitation: We audit OEM factories, negotiate vendor terms, and onboard 3PL fulfillment directly for your entity.",
      agency: "None. Strictly limited to PowerPoint decks, brand logos, or superficial digital mockups.",
      accelerator: "None. The founder is left alone to navigate zoning, factory clearances, and contractor disputes.",
    ...
    },
    {
      ...
      studio1008: "Curated Tech & Sourced Talent: We architect the stack, configure open-source ERPs, and hire vetted engineers for your team.",

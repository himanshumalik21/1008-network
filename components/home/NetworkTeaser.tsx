      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {featured.map((opp) => (
            <div
              key={opp.id}
              className="rounded-2xl bg-surface-100/70 border border-white/[0.08] p-6 flex flex-col justify-between hover:border-cyan-500/30 transition-all duration-300 relative group"
            >
              <div>
                ...
                <div className="p-3 rounded-lg bg-surface-200/50 border border-white/[0.04] mb-4 text-xs space-y-1">
                  <div className="text-muted-foreground font-mono uppercase text-[10px]">FOUNDER BACKGROUND</div>
                  <div className="text-white font-medium">{opp.founderBackground.headline}</div>
                  <div className="text-muted">{opp.founderBackground.domainYears} years domain depth</div>
                </div>
              ...
              <div className="pt-4 border-t border-white/[0.06] flex items-center justify-between text-xs">
                <div>
                  <span className="text-muted text-[10px] block font-mono">EQUITY OFFER</span>
                  <span className="text-amber-400 font-mono font-semibold">{opp.equityRange}</span>
                </div>

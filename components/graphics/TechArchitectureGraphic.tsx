...
export function TechArchitectureGraphic() {
  ...
  const layers = [
    {
      icon: Code2,
      title: "Production Web & Mobile App",
      stack: "Next.js • React Native • Stripe/Razorpay",
      status: "Production Ready",
      metric: "<100ms Latency",
      detail: "Clean-code web and mobile storefronts engineered for high conversions and enterprise security.",
      color: "#00D4B2",
    },
    {
      icon: Database,
      title: "Automated ERP & Inventory",
      stack: "ERPNext • Frappe • GST E-Invoicing",
      status: "Zero-Latency Sync",
      metric: "Auto Reconciled",
      detail: "Automated inventory pipelines, vendor purchase orders, and statutory invoicing without manual overhead.",
      color: "#635BFF",
    },
    {
      icon: BarChart3,
      title: "Executive Margin & P&L Telemetry",
      stack: "Contribution Margins • CAC / LTV Dashboard",
      status: "Live Tracking",
      metric: "Real-Time P&L",
      detail: "Automated business intelligence and unit-economic visibility directly accessible by founders and board.",
      color: "#059669",
    },
  ];

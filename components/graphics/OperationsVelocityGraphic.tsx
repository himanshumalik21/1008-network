...
export function OperationsVelocityGraphic() {
  ...
  const stages = [
    {
      icon: Factory,
      title: "Batch Manufacturing & OEM Sourcing",
      sub: "Audited Suppliers • Pre-Negotiated MOQs",
      badge: "Sourced & Negotiated",
      badgeColor: "indigo",
      metric: "Direct Contract",
      highlight: "We identify, audit, and negotiate with verified OEM manufacturers, locking contract terms for your entity.",
    },
    {
      icon: Truck,
      title: "3PL Warehousing & Logistics Setup",
      sub: "Multi-City Hubs • Automated Waybill Tools",
      badge: "Partner Onboarded",
      badgeColor: "emerald",
      metric: "99.4% Fulfillment",
      highlight: "We select and onboard top-tier pan-India 3PL partners with automated courier routing and warehouse sync.",
    },
    {
      icon: Cpu,
      title: "Cloud ERP & GST Tooling Integration",
      sub: "Configured Ledger • Automated E-Invoicing",
      badge: "Configured Stack",
      badgeColor: "cyan",
      metric: "Tools Integrated",
      highlight: "We configure Frappe/ERPNext pipelines and billing APIs directly into your business for automated compliance.",
    },
    {
      icon: ShieldCheck,
      title: "Statutory Clearances & Governance",
      sub: "FSSAI / CDSCO / BIS • Legal Structuring",
      badge: "100% Compliant",
      badgeColor: "amber",
      metric: "Risk Shielded",
      highlight: "We facilitate regulatory licensing, legal registrations, and corporate governance for your entity.",
    },
  ];
